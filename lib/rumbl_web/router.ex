defmodule RumblWeb.Router do
  ...
  scope "/", RumblWeb do
    ...
    get "/", PageController, :home
    get "/sessions/home", SessionController, :home
    resources "/pages", PageController, only: [:index, :show, :new, :create]
    resources "/users", UserController, only: [:index, :show, :new, :create]
    resources "/sessions", SessionController, only: [:index, :create, :delete]
    resources "/exams", ExamController, only: [:index, :show, :new, :create]
  end
